...
public class LoopViewPager extends ViewPager {
    ...
    private long mAutoScrollInterval = -1;
    ...
    public void setCurrentItem(int item, boolean smoothScroll) {
        super.setCurrentItem(mAdapter != null ? mAdapter.toInnerPosition(item) : 0, smoothScroll);
    }
        ...
        public void run() {
            if (mAdapter != null) {
                ...
                if (position == mAdapter.getCount() - 1) {
                    setCurrentItem(mAdapter.toRealPosition(position), false);
                } else {
                    setCurrentItem(getCurrentItem() + 1);
                }
            }
            if (mAutoScrollInterval > 0) {
                postDelayed(mScrollRunnable, mAutoScrollInterval);
            }
        }
    };
