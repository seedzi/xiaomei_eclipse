...
public class HomeAdapter extends ArrayAdapter<Section> {
        ...
        itemView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Section.TYPE_DETAIL.equals(section.getType())) {
                    GoodsDetailActivity.startActivity(activity, entity.getUrl(),entity.getTitle(),entity.getImg());
    ...
    private void setNavOnClickListener(View view, final String url) {
        view.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                GoodsDetailActivity.startActivity((Activity) v.getContext(), url,null,null);
            }
        });
    }
