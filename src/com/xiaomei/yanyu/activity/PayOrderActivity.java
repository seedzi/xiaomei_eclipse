...
public class PayOrderActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOrder = getIntent().getParcelableExtra(IntentExtra.EXTRA_ORDER);
    ...
    private void pay() {
        switch (mPaymentSelection) {
            case WECHAT_PAYMENT:
                // XiaoMeiApplication.getInstance().getApi().payWechat(mOrder.getDataList().getId(),
            ...
            case ALIPAY_PAYMENT:
                ...
                ZhifubaoPayManager.getInstance().pay(mOrder.getDataList().getGoodsName(),
                        mOrder.getDataList().getGoodsName(), mOrder.getDataList().getGoodsPay(),
