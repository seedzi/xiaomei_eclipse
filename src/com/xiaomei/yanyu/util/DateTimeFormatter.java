  ...
  */
  ...
  private String fullMonth(Integer aMonth){
    ...
    private String lookupCustomMonthFor(Integer aMonth) {
        ...
        if (fCustomLocalization == null || fCustomLocalization.Months == null) {
            return EMPTY_STRING;
        }
  ...
  private String fullWeekday(Integer aWeekday){
    ...
    private String lookupCustomWeekdayFor(Integer aWeekday) {
        if (fCustomLocalization == null || fCustomLocalization.Weekdays == null) {
            return EMPTY_STRING;
        }
  ...
  private String lookupCustomAmPmFor(Integer aHour){
    String result = EMPTY_STRING;
        if (fCustomLocalization != null && fCustomLocalization.AmPmIndicators != null) {
            if (aHour < 12) {
